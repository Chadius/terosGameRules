...
type LevelUpBenefit struct {
	...
	PowerIDGained      []*power.PowerReference    `json:"powers" yaml:"powers"`
	PowerIDLost        []*power.PowerReference    `json:"powers_lost" yaml:"powers_lost"`
	Movement           *squaddie.SquaddieMovement `json:"Movement" yaml:"Movement"`
}
